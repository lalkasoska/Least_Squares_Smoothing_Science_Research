...
def fitness_func(x, y, y_real, yx, yx2, x2, x3, x4, func_lambd, individual, table, smoothEdges, deviationType,
                 countEdges, realtime, savepath=None, func=None):
    shoulder_length = sum((2 ** ind) * bit for ind, bit in enumerate(individual))
    return Approximator.smooth(shoulder_length, x, y, y_real, yx, yx2, x2, x3, x4)
